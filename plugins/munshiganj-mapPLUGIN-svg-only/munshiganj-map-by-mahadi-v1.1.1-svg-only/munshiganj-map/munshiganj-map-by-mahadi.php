...
function mmbm_default_links() {
    return array(
        ...
        'tongibari'   => array('label' => 'টঙ্গিবাড়ী', 'url' => ''),
        'munshiganj'  => array('label' => 'মুন্সিগঞ্জ সদর', 'url' => ''),
...
function mmbm_enqueue_assets_once() {
    ...
    wp_register_style('mmbm-style', plugins_url('assets/mmbm.css', __FILE__), array(), '1.1.2');
    wp_register_script('mmbm-script', plugins_url('assets/mmbm.js', __FILE__), array(), '1.1.2', true);
